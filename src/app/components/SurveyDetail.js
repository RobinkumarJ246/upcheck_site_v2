          ...
          <>
            ...
            <div className="mt-6 text-center">
              <button
                ...
                className="px-4 py-2 bg-gradient-to-r from-teal-500 to-blue-600 text-white rounded-lg shadow hover:shadow-lg transition-all flex items-center justify-center mx-auto"
                disabled={submitting}
              >
                {submitting ? (
                  <>
          ...
          <>
            <div className="text-center">
              ...
              <button 
                ...
                className="px-4 py-2 bg-gradient-to-r from-teal-500 to-blue-600 text-white rounded-lg shadow hover:shadow-lg transition-all"
              >
                Back to Surveys
              </button>
            </div>
      ...
      <div className="max-w-3xl mx-auto my-8 p-8 bg-white rounded-xl shadow-xl">
        <div className="text-center">
          <div className="relative inline-block">
            <div className="absolute inset-0 bg-gradient-to-r from-teal-400 to-blue-500 rounded-full opacity-20 blur-xl"></div>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="relative h-20 w-20 mx-auto text-teal-500 mb-6"
              fill="none"
              viewBox="0 0 24 24"
              stroke="currentColor"
            >
          ...
          <h2 className="text-3xl font-bold mb-4 bg-gradient-to-r from-teal-500 to-blue-600 bg-clip-text text-transparent">Thank You!</h2>
          <p className="text-gray-700 text-lg mb-8">
            {thankYouMessage || 'Your survey response has been submitted successfully.'}
          </p>
          <button
            onClick={() => router.push('/surveys')}
            className="px-6 py-3 bg-gradient-to-r from-teal-500 to-blue-600 text-white rounded-lg shadow-md hover:shadow-lg transform hover:-translate-y-1 transition-all duration-300"
          >
            Back to Surveys
          </button>
        </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
          ...
          {survey.questions && survey.questions.map((question, index) => (
            <div key={question.id} className="p-6 border rounded-xl shadow-sm bg-white hover:shadow-md transition-shadow">
              <h3 className="text-lg font-medium mb-3 flex items-start">
                <span className="flex-shrink-0 w-6 h-6 flex items-center justify-center rounded-full bg-gradient-to-r from-teal-500 to-blue-500 text-white text-sm mr-2">
                  {index + 1}
                </span>
                ...
                <div className="ml-8">
                  <div className="relative">
                    <select
                      value={responses[question.id] || ''}
                      onChange={(e) => handleInputChange(question.id, e.target.value)}
                      className="w-full px-4 py-3 border border-gray-300 rounded-lg appearance-none focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent transition-all pr-10"
                      required={question.required}
                    >
                    ...
                    {[...Array(5)].map((_, i) => {
                      ...
                      return (
                        <button
                          ...
                          className={`w-12 h-12 rounded-full focus:outline-none transition-all ${
        ...
        <div className="flex justify-end mt-8">
          <button
            type="submit"
            disabled={submitting}
            className={`px-6 py-3 rounded-lg text-white font-medium flex items-center justify-center min-w-[150px] ${
              submitting 
                ? 'bg-gradient-to-r from-teal-400 to-blue-500 cursor-wait' 
                : 'bg-gradient-to-r from-teal-500 to-blue-600 hover:shadow-lg transform hover:-translate-y-1 transition-all duration-300'
            }`}
          >
            {submitting ? (
              <>
