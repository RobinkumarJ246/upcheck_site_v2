...
import { PiChartLineUp, PiShieldWarning, PiFish, PiUsersThree } from 'react-icons/pi';
        ...
        <div className="mt-20 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
          {features.map((feature, index) => (
            ...
            >
              ...
              <div className="absolute inset-0 rounded-xl ring-1 ring-inset ring-slate-100 group-hover:ring-brand-cyan/50 transition-colors duration-300" />
            </div>
          ))}
        </div>
