    ...
    <div className="min-h-screen bg-gradient-to-b from-teal-100 to-blue-50 flex flex-col justify-center items-center text-center px-6">
      ...
      <div className="bg-white rounded-lg shadow-lg p-8 max-w-3xl">
        ...
        <p className="text-gray-600 mb-6">
          We're excited to have you on board! You'll now receive the latest updates, articles, and insights about shrimp farming, aquaculture, and market trends.
        </p>
        <p className="text-gray-600 mb-6">
          Stay tuned for valuable content tailored just for you!
        </p>
