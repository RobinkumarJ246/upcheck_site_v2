    ...
    <div className="min-h-screen bg-slate-50 text-slate-800">
          ...
          <div className="lg:grid lg:grid-cols-12 lg:gap-8">
            <div className="sm:text-center md:mx-auto lg:col-span-6 lg:text-left mt-8">
              <h1 className="text-4xl font-bold tracking-tight text-slate-900 sm:text-5xl md:text-6xl">
                <span className="block text-slate-900">About UpCheck</span>
              </h1>
              <h1 className="text-4xl font-bold tracking-tight text-slate-900 sm:text-3xl md:text-4xl">
                <span className="block bg-gradient-to-r from-brand-blue to-brand-cyan bg-clip-text text-transparent mt-4 pb-2">Our Mission & Vision</span>
              </h1>
      ...
      <div className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center max-w-3xl mx-auto">
            <h2 className="text-4xl font-bold text-slate-900 sm:text-5xl mb-6">{t.story_title}</h2>
          </div>

          <div className="mt-12 max-w-4xl mx-auto">
            <div className="bg-white p-8 rounded-xl shadow-[0_4px_20px_-2px_rgba(0,0,0,0.1)] border border-slate-100">
      ...
      <div className="py-24 bg-slate-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          {/* Title Section */}
          <div className="text-center max-w-3xl mx-auto">
            <h2 className="text-4xl font-bold text-slate-900 sm:text-5xl mb-6">The Values We Add</h2>
      ...
      <div className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          {/* Title Section */}
          <div className="text-center max-w-3xl mx-auto">
            <h2 className="text-4xl font-bold text-slate-900 sm:text-5xl mb-6">Our Team</h2>
            <p className="text-xl text-slate-600">
              ...
              >
                <div className="relative mx-auto w-24 h-24 mb-6">
                  ...
                  <img
                    src={member.img}
                    alt={member.name}
                    className="w-24 h-24 mx-auto rounded-full object-cover relative z-10 border-2 border-white shadow-md"
                  />
                </div>
      ...
      {/* Call to Action */}
      <section className="py-12 bg-gradient-to-r from-blue-900 to-teal-600 text-white text-center">
        <div className="max-w-4xl mx-auto px-4">
          <h2 className="text-2xl md:text-3xl font-bold mb-4">Download the UpCheck App</h2>
          <p className="mb-6 opacity-90">Experience the future of shrimp farming. Our app is currently in development, but stay tuned!</p>
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <button className="bg-white/10 hover:bg-white/20 backdrop-blur-sm border border-white/30 text-white px-6 py-3 rounded-lg flex items-center space-x-3 font-bold transition-all">
              <FaAndroid size={20} />
              <span>Download for Android</span>
            </button>
            <button className="bg-white text-blue-900 hover:bg-slate-50 px-6 py-3 rounded-lg flex items-center space-x-3 font-bold transition-all shadow-lg">
              <FaApple size={20} />
      ...
      <div className="py-24 bg-slate-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          {/* Title Section */}
          <div className="text-center max-w-3xl mx-auto">
            <h2 className="text-4xl font-bold text-slate-900 sm:text-5xl mb-6">FAQs</h2>
            <p className="text-xl text-slate-600">
            ...
            {faqs.map((faq, index) => (
              ...
              >
                ...
                >
                  ...
                  <div className={`p-2 rounded-full bg-slate-50 transition-transform duration-300 ${faq.isOpen ? 'rotate-180 bg-slate-100' : 'rotate-0'}`}>
